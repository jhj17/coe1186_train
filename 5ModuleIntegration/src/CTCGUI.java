...
public class CTCGUI {
	...
	protected void createContents() {
		...
		btnOpen.setBounds(480, 454, 75, 25);
		...
		btnClose.setBounds(600, 454, 75, 25);
		btnClose.setText("Close ");
		
		textOpenClose = new Text(shell, SWT.MULTI | SWT.BORDER | SWT.WRAP);
		textOpenClose.setBounds(456, 325, 277, 123);
